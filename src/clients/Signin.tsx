            ...
            <div className="flex w-1/2 justify-center items-center bg-white">
                <form className="bg-white">
                    ...
                    <div className="flex  space-x-2 justify-center items-end bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-md transition duration-100 ">
                        <img src="https://i.imgur.com/arC60SB.png" alt="" className=" h-5 cursor-pointer" />
                        <button >Sign-in with google</button>
                    </div>
                    <div className="flex  space-x-2 justify-center items-end bg-gray-700 hover:bg-gray-600 text-white py-2 rounded-md transition duration-100 mt-3">
                        <img src="" alt="" className=" h-5 cursor-pointer" />
